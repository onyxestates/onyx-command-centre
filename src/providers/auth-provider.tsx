...
import { assertFirebaseClientEnvReady, firebaseEnvStatus } from "@/lib/env";
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (!firebaseEnvStatus.isConfigured && process.env.NEXT_PUBLIC_USE_FIREBASE_EMULATORS !== "true") {
      logWarn(firebaseEnvStatus.message ?? "Firebase environment is not configured.");
    }
  }, []);
